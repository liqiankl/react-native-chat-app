...
export class ChatScreen extends Component {
      ...
      headerRight: (
        <View style={{ flex: 1 }}>
          <View style={{ flexDirection: "row" }}>
            <TouchableOpacity
              onPress={() => {
                state.params.initiateCall("video", state.params.navigation);
              }}
            >
            ...
            <TouchableOpacity
              onPress={() => {
                state.params.initiateCall("audio", state.params.navigation);
              }}
            >
              <MaterialCommunityIcons
                style={{ padding: 8 }}
    ...
    if (isMyMess) {
      ...
      return (
        <View style={{ flexDirection: "row" }}>
          ...
          >
            <Text style={[styles.item, { color: "#797777" }]}>
              {item.data.text}
            </Text>
          </View>
        </View>
  ...
  renderItem = ({ item }) => {
    ...
    isMyMess = false;
    console.log(item, "deliveredAt" in item);
